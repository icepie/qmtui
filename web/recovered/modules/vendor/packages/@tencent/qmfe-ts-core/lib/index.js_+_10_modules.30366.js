...
// UNUSED EXPORTS: DebounceEmitter, LinkedList, PauseableEmitter, URI, uriToFsPath

;// CONCATENATED MODULE: ./node_modules/@tencent/qmfe-ts-core/lib/core/base/common/platform.js
var _a;
...
;// CONCATENATED MODULE: ./node_modules/@tencent/qmfe-ts-core/lib/core/base/common/stopwatch.js
...
;// CONCATENATED MODULE: ./node_modules/@tencent/qmfe-ts-core/lib/core/base/common/LinkedList.js
class Node {
    constructor(element) {
...
;// CONCATENATED MODULE: ./node_modules/@tencent/qmfe-ts-core/lib/core/base/common/iterator.js
var Iterable;
(function (Iterable) {
    function is(thing) {
...
;// CONCATENATED MODULE: ./node_modules/@tencent/qmfe-ts-core/lib/core/base/common/lifecycle.js
...
function dispose(arg) {
    if (Iterable.is(arg)) {
        ...
        if (errors.length === 1) {
            ...
            return new MultiDisposeError(errors);
        }
...
;// CONCATENATED MODULE: ./node_modules/@tencent/qmfe-ts-core/lib/core/base/common/event.js
...
class Emitter {
    ...
    get event() {
        if (!this._event) {
            this._event = (listener, thisArgs, disposables) => {
                ...
                const isListenersEmpty = this._listeners.isEmpty();
                if (isListenersEmpty && this._options && this._options.onFirstListenerAdd) {
                    this._options.onFirstListenerAdd(this);
                }
                const remove = this._listeners.push(!thisArgs ? listener : [listener, thisArgs]);
                if (isListenersEmpty && this._options && this._options.onFirstListenerDidAdd) {
    ...
    fire(event) {
        var _a, _b;
        if (this._listeners) {
            if (!this._deliverQueue) {
                this._deliverQueue = new LinkedList_LinkedList();
            }
            for (let listener of this._listeners) {
                this._deliverQueue.push([listener, event]);
            }
            (_a = this._perfMon) === null || _a === void 0 ? void 0 : _a.start(this._deliverQueue.size);
            while (this._deliverQueue.size > 0) {
                const [listener, event] = this._deliverQueue.shift();
                try {
    ...
    dispose() {
        ...
        if (!this._disposed) {
            ...
            (_b = this._deliverQueue) === null || _b === void 0 ? void 0 : _b.clear();
...
;// CONCATENATED MODULE: ./node_modules/@tencent/qmfe-ts-core/lib/core/base/common/process.js
/*---------------------------------------------------------------------------------------------
...
;// CONCATENATED MODULE: ./node_modules/@tencent/qmfe-ts-core/lib/core/base/common/path.js
/*---------------------------------------------------------------------------------------------
 *  Copyright (c) Microsoft Corporation. All rights reserved.
 *  Licensed under the MIT License. See License.txt in the project root for license information.
 *--------------------------------------------------------------------------------------------*/
...
const isAbsolute = (process_platform === 'win32' ? win32.isAbsolute : posix.isAbsolute);
const join = (process_platform === 'win32' ? win32.join : posix.join);
...
const format = (process_platform === 'win32' ? win32.format : posix.format);
const parse = (process_platform === 'win32' ? win32.parse : posix.parse);
const toNamespacedPath = (process_platform === 'win32' ? win32.toNamespacedPath : posix.toNamespacedPath);
const sep = (process_platform === 'win32' ? win32.sep : posix.sep);
const delimiter = (process_platform === 'win32' ? win32.delimiter : posix.delimiter);
//# sourceMappingURL=path.js.map
;// CONCATENATED MODULE: ./node_modules/@tencent/qmfe-ts-core/lib/core/base/common/url.js
/*---------------------------------------------------------------------------------------------
 *  Copyright (c) Microsoft Corporation. All rights reserved.
...
class Uri extends (/* unused pure expression or super */ null && (URI)) {
    constructor() {
        super(...arguments);
...
;// CONCATENATED MODULE: ./node_modules/@tencent/qmfe-ts-core/lib/core/base/common/index.js



//# sourceMappingURL=index.js.map
;// CONCATENATED MODULE: ./node_modules/@tencent/qmfe-ts-core/lib/index.js

//# sourceMappingURL=index.js.map

//# sourceURL=webpack://qqmusic/./node_modules/@tencent/qmfe-ts-core/lib/index.js_+_10_modules?